...
// int[] arrayInteriosDobrado = new int[arrayInteriros.Length * 2];
// Array.Copy(arrayInteriros, arrayInteriosDobrado, arrayInteriros.Length);


// //Array.Resize(ref arrayInteriros, arrayInteriros.Length * 2);


// Console.WriteLine("Percorrendo o Arrayy com o FOR");
// for(int contador = 0; contador < arrayInteriros.Length; contador++)
// {
//     Console.WriteLine($"Posiçao N {contador} - {arrayInteriros[contador]}");
// }
...
// {
//     Console.WriteLine($"Posiçao N {contadorForeach} - valor");
//     contadorForeach++;
// }
